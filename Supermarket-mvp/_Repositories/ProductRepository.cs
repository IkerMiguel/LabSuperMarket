    ...
    internal class ProductRepository : BaseRepository, IProductRepository
    {
        ...
        public void Add(ProductModel productModel)
        {
            ...
            using (var command = new SqlCommand())
            {
                ...
                command.CommandText = "INSERT INTO Product VALUES (@name, @price, @stock, @categorie)";
                ...
                command.Parameters.Add("@categorie", SqlDbType.Int).Value = productModel.CategorieId;
            ...
            using (var command = new SqlCommand())
            {
                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        productModel.CategorieId = (int)reader["Categorie_Id"];
